...
#                                                     #
#   Made minor adjustments: 2016.08.22 - GR           #
#######################################################
...
function remoteConnect {
    ...
    Start-Process mstsc -Credential $credentials -ArgumentList "/shadow: $($newResult.UnifiedSessionId) /control /v: $($newResult.HostServer)"
}
